  ...
  <q-page style="margin-top:10px;" padding class="  justify-center">
      <div class="row justify-center">
        ...
        <q-btn-group push>
           ...
           <q-btn color="blue" @click="filterRole('超级管理员')" glossy text-color="black" label="超级管理员" />
           <q-btn color="blue" @click="filterRole('仓库管理员')" glossy text-color="black" label="仓库管理员" />
           <q-btn color="blue" @click="filterRole('订单管理员')" glossy text-color="black" label="订单管理员" />
        </q-btn-group>
      </div>
      <div class="row justify-center">
      ...
      <div class="row justify-center" style="margin-top:20px;">
        <q-list highlight inset-separator style="width:300px;">
          <q-item v-for="item in user_items" v-bind:key="item.user_id">
             <q-item-side v-if="item.role_name==='订单管理员'" avatar="statics/waiter.png" />
             <q-item-side v-if="item.role_name==='仓库管理员'" avatar="statics/cook.png" />
             <q-item-side v-if="item.role_name==='超级管理员'" avatar="statics/admin.png" />
