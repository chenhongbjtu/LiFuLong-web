    ...
    <div style="max-width: 90vw; margin-top:10px;" >
      ...
      <div class="row justify-center">
        ...
        <template slot="top-left" slot-scope="props">
          <q-btn v-if="props!=null" title="返回地址视图" color="purple-7" label="返回" icon="keyboard_return" @click="goPage('/order-by-table')" />
          <q-btn style="margin-left:10px;" v-if="props!=null"  title="分配产品到仓库" color="teal-6" label="分配到仓库" @click="assignItemsByTable" icon="assignment_returned" />
          <q-btn style="margin-left:10px;" title="结束订单(已买单)" color="positive" label="结束本次订单" @click="finishOrder" icon="done all" />
          <q-btn style="margin-left:10px;" v-if="props!=null" title="添加产品" label="添加产品" color="blue" @click="goToOrderPage" icon="add" />
        ...
        <q-td slot="body-cell-Status" slot-scope="props" :props="props">
          ...
          <q-chip v-else-if="props.value==='assigned'" small color="lime-14">备货中</q-chip>
          <q-chip v-else-if="props.value==='readytoserve'" small color="deep-orange-6">运输中</q-chip>
          <q-chip v-else-if="props.value==='served'" small color="light-green-10">已送达</q-chip>
        ...
        <q-td style="max-width:150px;min-width:100px;" slot="body-cell-Action" slot-scope="props" :props="props">
          <q-btn v-if="props.row.status==='readytoserve'" @click="served(props.row.id)" icon="speaker_notes_off" dense glossy color="purple-13" label="已送达" />
        </q-td>
       </q-table>
      </div>
    </div>
