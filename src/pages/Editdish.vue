  ...
  <q-page style="margin-top:10px;" class="row justify-center">
    <div style="width: 400px; max-width: 90vw; " >
      ...
      <q-field icon="description">
        <q-input v-model="description" placeholder="产品运输方式" />
      </q-field>
      ...
      <q-field icon="timer" label="运输时间(小时)" :label-width="5">
         <q-input type="number"  max-length="16" v-model="expected_cooking_time" />
      </q-field>
      <q-field icon="timer" label="价格（元）" :label-width="5">
         <q-input type="number"  max-length="16" v-model="price" />
      </q-field>
      <q-field>
        <q-btn  @click="goPage('/dish-manage')"  icon="keyboard return" color="purple-7" label="返回产品列表" />
